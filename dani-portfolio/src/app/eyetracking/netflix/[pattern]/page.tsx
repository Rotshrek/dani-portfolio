...
export default function Netflix() {
    const params = useParams(),
        [chosenPlan, setChosenPlan] = useState<string | null>(params?.pattern === "dark" ? plans[2].name : null),
        [step, setStep] = useState(1)

    return (
        <main>
            <div className="border-b-[1px] border-[#dce2e5] py-4 px-10 flex justify-between items-center">
                <svg
                    className="w-[166px]"
                    viewBox="0 0 111 30"
                    version="1.1"
            ...
            {step === 2 && <Step2 chosenPlan={chosenPlan} setChosenPlan={setChosenPlan} setStep={setStep} />}

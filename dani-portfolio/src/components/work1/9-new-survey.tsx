                    ...
                    <div className="md:col-span-10">
                        <div className="m-auto text-center ">
                            <div className="flex justify-between items-center">
                                <div className="flex-initial w-[140px] md:w-[220px] ml-4 p-4 flex-1 bg-lighterPurple text-gray-800 p-2 rounded relative">
                                    <p>The illustration brings it to life</p>

                                    <div className="absolute bottom-1/4 right-0 transform translate-x-1/2 rotate-45 w-4 h-4 bg-lighterPurple"></div>
                                </div>
                                <div className="text-center">
                                    <p className="text-7xl font-display">79%</p>
                                    <p className="text-md">of users prefer the layout with illustration.</p>
                                </div>
                                <div className="flex-initial w-[170px] md:w-[220px] ml-4 p-4 flex-1 bg-lighterPurple text-gray-800 p-2 rounded relative">
                                    <p>
                                        It&#39;s like the illustration of the good vibes company and I think that
                                        inspires confidence
                                    </p>

                                    <div className="absolute bottom-1/2 left-0 transform -translate-x-1/2 rotate-45 w-4 h-4 bg-lighterPurple"></div>
                                </div>
                            </div>
                        </div>
                    </div>

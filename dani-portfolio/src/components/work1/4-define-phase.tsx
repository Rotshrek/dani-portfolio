    ...
    return (
        <div className="w-screen bg-white min-h-screen">
            <div className={gridClasses + " gap-y-4"}>
                <div className="pr-20 md:pr-0 md:col-span-12">
                    <p className="font-display text-4xl md:text-6xl mb-8 text-center">Define phase</p>
                    <p className="font-display text-lightPink text-2xl">User flow first approach</p>
                </div>
                <div className="pr-20 md:pr-0 md:col-span-6">
                    <p className="text-lg">
                ...
                <div className="relative md:col-span-12 h-[456px] w-screen md:w-auto overflow-scroll md:overflow-visible ml-[-30px] md:ml-0">
                    <div className="absolute w-[1280px] h-[456px] md:left-1/2 md:translate-x-[-50%]">
                        <Image src="/compara-flow.png" fill alt="national identity form flow" />
                    </div>
                </div>
                <div className="pr-20 md:pr-0 md:col-span-12 mt-8">
                ...
                <div className="md:col-span-6">
                    <p className="text-lg pr-20 md:pr-0">
                ...
                <div className="md:col-span-6 mt-8">
                    <p className="text-lg mb-6 pr-20 md:pr-0">
                ...
                <div className="md:col-span-6 mt-8">
                    ...
                    <div className="flex items-center md:justify-center">
                        ...
                        <div>
                            <div className="w-[240px] md:w-[400px] ml-4 p-4 flex-1 bg-lighterPurple text-gray-800 p-2 rounded relative">
                                <p>

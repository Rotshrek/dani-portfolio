    ...
    return (
        <div className="w-screen bg-white min-h-screen">
            <div className={gridClasses + " gap-y-4"}>
                <div className="md:col-span-6 pr-12 md:pr-0">
                ...
                <div className="md:col-span-6 mt-4 md:mt-8 pr-12 md:pr-0">
                ...
                <div className="relative md:col-span-12 h-[403px] hidden md:block">
                    <div className="md:absolute md:w-[1280px] md:h-[403px] md:left-1/2 md:translate-x-[-50%]">
                        <Image src="/new-input-details.png" fill alt="New form flow" />
                    </div>
                </div>
                <div className="md:col-span-12 md:mt-8 pr-12 md:pr-0">
